...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-07-11 08:40`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e6a633d7-a012-4085-9d6a-8ec437ee7f72.git
$ cd e6a633d7-a012-4085-9d6a-8ec437ee7f72
```
